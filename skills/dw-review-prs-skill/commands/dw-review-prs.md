---
name: dw-review-prs
description: Review the PRs waiting on you and leave the findings as an unsubmitted [dev-ai] review.
---

# /dw-review-prs

Draft the reviews waiting on you. Reads your review queue, reads what you and everyone else already
said on each PR, then leaves each finding as a **pending (unsubmitted)** `[dev-ai]` comment for you
...
event. Every draft carries the `[dev-ai]` tag. A PR whose head SHA is already recorded in the store
